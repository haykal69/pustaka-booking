...
class Laporan extends CI_Controller
{
	...
	{
		// $this->load->library('dompdf_gen'); //jika versi php 7.1 ke bawah
		...
		$orientation = 'landscape'; //tipe format kertas potrait or landscape
		$html = $this->output->get_output();

		$dompdf->set_paper($paper_size, $orientation); // convert to pdf
		$dompdf->load_html($html);
		$dompdf->render();
		$dompdf->stream("laporan_data_buku.pdf", array('Attachment' => 0)); //untuk nama file pdfnya
	}
